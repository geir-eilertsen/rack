...
public class SpringAiQueryExpander implements QueryExpander {
    ...
    private static final String PROMPT = """
        ...
        - Do not repeat the query itself, and do not invent a term just to fill
          the array. An empty array is a fine answer when the query is already
          the word this inventory uses.
    ...
    private static List<String> clean(List<String> terms, String query) {
